...
from geneticengine.core.representations.tree_smt.initializations import (
    InitializationMethodType,
    grow_method,
)
from geneticengine.core.representations.tree_smt.initializations import mk_save_init
from geneticengine.core.representations.tree_smt.initializations import pi_grow_method
from geneticengine.core.representations.tree_smt.utils import relabel_nodes
...
class DefaultSMTTBMutation(MutationOperator[TreeNode]):
...
class TypeSpecificSMTTBMutation(DefaultSMTTBMutation):
...
class DefaultSMTTBCrossover(CrossoverOperator[TreeNode]):
...
class TypeSpecificTBCrossover(DefaultSMTTBCrossover):
    """Selects a sub-tree from one parent and replaces it with a compatible
    tree from the other parent."""
...
class SMTTreeBasedRepresentation(Representation[TreeNode, TreeNode]):
    ...
    def get_mutation(self) -> MutationOperator[TreeNode]:
        return DefaultSMTTBMutation()

    def get_crossover(self) -> CrossoverOperator[TreeNode]:
        return DefaultSMTTBCrossover()
