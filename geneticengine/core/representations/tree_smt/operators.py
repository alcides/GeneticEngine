...
from geneticengine.core.representations.tree_smt.initializations import full_method, grow_method
...
class SMTFullInitializer(PopulationInitializer):
...
class SMTGrowInitializer(PopulationInitializer):
...
class SMTPositionIndependentGrowInitializer(PopulationInitializer):
    """All individuals are created expanding productions until a maximum depth,
    but without the requirement of reaching that depth."""
...
class SMTRampedInitializer(PopulationInitializer):
...
class SMTRampedHalfAndHalfInitializer(PopulationInitializer):
...
class SMTInjectInitialPopulationWrapper(PopulationInitializer):
