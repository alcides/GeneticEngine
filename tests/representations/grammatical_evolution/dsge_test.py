...
from geneticengine.core.representations.grammatical_evolution.dynamic_structured_ge import create_tree
...
class TestInitializers:
    def test_ramped_half_and_half(self):
        ...
        pop = RampedHalfAndHalfInitializer().initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
        )
...
class TestInitializersMinDepth:
    def test_ramped_half_and_half(self):
        r = RandomSource(seed=1)
        g = extract_grammar([Root, RootSuper, Rec, Leaf, LeafLiteral, LeafVar], Root, False)
        problem = SingleObjectiveProblem(
        ...
        min_depth = 5
        max_depth = 10
        pop = RampedHalfAndHalfInitializer(min_depth).initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
    ...
    def test_ramped(self):
        ...
        min_depth = 5
        max_depth = 10
        pop = RampedInitializer(min_depth).initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
    ...
    def test_pi_grow(self):
        ...
        min_depth = 5
        max_depth = 10
        pop = PositionIndependentGrowInitializer(min_depth).initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
    ...
    def test_grow(self):
        ...
        min_depth = 5
        max_depth = 10
        pop = GrowInitializer(min_depth).initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
    ...
    def test_full(self):
        ...
        min_depth = 5
        max_depth = 10
        pop = FullInitializer(min_depth).initialize(
            problem,
            DynamicStructuredGrammaticalEvolutionRepresentation(g, max_depth=max_depth),
            r,
            5,
